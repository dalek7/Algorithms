...
%% Comparison between Shortest angle and non-shortest
figure;
quiver3(0,0,0, R_craig(1,1), R_craig(2,1), R_craig(3,1),'b');hold on;
quiver3(0,0,0, R_craig(1,2), R_craig(2,2), R_craig(3,2),'b');
quiver3(0,0,0, R_craig(1,3), R_craig(2,3), R_craig(3,3),'b');


if bShowXYAxis==1
    quiver3(0,0,0, R_XYZ(1,1), R_XYZ(2,1), R_XYZ(3,1),'r:');
    quiver3(0,0,0, R_XYZ(1,2), R_XYZ(2,2), R_XYZ(3,2),'r:');


    quiver3(0,0,0, R_XY(1,1), R_XY(2,1), R_XY(3,1),'g--');
    quiver3(0,0,0, R_XY(1,2), R_XY(2,2), R_XY(3,2),'g--');
end

plot3(p3T1(:,1), p3T1(:,2),p3T1(:,3), 'b-'), 
plot3(p3T2(:,1), p3T2(:,2),p3T2(:,3), 'r:'), 
plot3(p3T3(:,1), p3T3(:,2),p3T3(:,3), 'g--'), 
...
return;
figure;
quiver3(0,0,0, R_craig(1,1), R_craig(2,1), R_craig(3,1),'r');hold on;
quiver3(0,0,0, R_craig(1,2), R_craig(2,2), R_craig(3,2),'g');
quiver3(0,0,0, R_craig(1,3), R_craig(2,3), R_craig(3,3),'b');
...
if bShowXYAxis==1
    ...
    quiver3(0,0,0, R_XY(1,1), R_XY(2,1), R_XY(3,1),'r--');
    quiver3(0,0,0, R_XY(1,2), R_XY(2,2), R_XY(3,2),'g--');
end

plot3(p3T1(:,1), p3T1(:,2),p3T1(:,3), 'k-'), 
plot3(p3T2(:,1), p3T2(:,2),p3T2(:,3), 'k:'), 
plot3(p3T3(:,1), p3T3(:,2),p3T3(:,3), 'k--'), 
% plot(p(:,1), p(:,2), '.-'), axis equal
